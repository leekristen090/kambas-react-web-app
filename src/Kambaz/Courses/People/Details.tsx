...
export default function PeopleDetails() {
    ...
    if (!uid) return null;
    return (
        <div className={"position-fixed top-0 end-0 bottom-0 bg-white p-4 shadow w-25"} id={"wd-people-details"}>
            <button onClick={() => navigate(-1)} className={"btn position-fixed end-0 top-0"} id={"wd-close-details"}>

        ...
        <Container>
            ...
            <div id={"wd-css-id-selectors"}>
                ...
                <p id={"wd-id-selector-1"}>Instead of changing the look and feel of all the elements
                    of the same name, e.g., P, we can refer to a specific element by its ID.</p>
                <p id={"wd-id-selector-2"}>Here's another paragraph using a different ID and a
                    different look and feel.</p>
            </div>

            <div id={"wd-css-class-selectors"}>
                <h3>Class Selectors</h3>
                <p className={"wd-class-selector"}>Instead of using IDs to refer to elements, you
                    can use an element's CLASS attribute.</p>
            ...
            <div id={"wd-css-document-structure"}>
                <div className={"wd-selector-1"}>
                    ...
                    <div className={"wd-selector-2"}>
                        ...
                        <p className={"wd-selector-3"}>This paragraph's background is referenced as
                        <br />
